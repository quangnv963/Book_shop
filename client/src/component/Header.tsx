...
const Header = () => {
  ...
  return (
    <header>
      <div className='z-[10] fixed w-full bg-[white] px-[20px] md:px-[30px] xl:px-[50px] 2xl:px-[100px] top-[0] nav flex justify-between items-center h-[120px]'>
        ...
        <div className="menu">
          ...
          <ul id='navmobile' className={navBar ? 'z-[2] block absolute top-[0px] right-[0px] bg-[#007bff] w-full h-[400px] text-center xl:hidden' : 'hidden'}>
            <li className="xl:px-6 2xl:px-8v first-letter:cursor-pointer hover:bg-[white]"><a href="/">Trang chủ</a> </li>
          ...
          <ul className="hidden xl:flex  text-[#4A4A4A] font-sans xl:text-[16px] 2xl:text-[24px]">
            <li className="xl:px-6 2xl:px-8 hover:cursor-pointer hover:text-[#007bff]"><a href="/">Trang chủ</a></li>
            ...
            <li className="xl:px-6 2xl:px-8 hover:cursor-pointer hover:text-[#007bff]"><div className='relative'>
              ...
              <p className='absolute top-[26px] left-7 bg-[red] px-[11px] pt-1 rounded-[50%] text-white text-[19px] w-[35px]'>5</p></div></li>       
          </ul>
        </div>
      </div>
